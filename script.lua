...
if v1 ~= "Pirates" or v1 ~= "Marines" then
    if Settings['Team'] ~= "Pirates" and Settings['Team'] ~= "Marines" then
        local args = {
            [1] = "SetTeam",
            [2] = "Marines",
        }
...
Aimbot_Settings = AllFunS(Tabs.Combat,"Aimbot Settings")
Other = AllFunS(Tabs.Combat,"Other")
...
local BossDrop = AllFunD(Boss,"Select Boss",nil,bossCheck,false,false,"Select Boss",true)
...
local PlayerDrop = AllFunD(Combat,"Select Players",nil,getPlayers(),nil,false,"Select Players",true)
local PositionDrop = AllFunD(Combat,"Position",nil,{ "Above", "Beside", "Lower" },"Above",false,"Position",true)
AllFunB(Combat, "Refresh Players", nil, function() PlayerDrop:SetValues(getPlayers()) end)
AllFun(Combat,"Spectate to Players",nil,false,"Spectate to Players")
AllFun(Combat,"Teleport to Players",nil,false,"Teleport to Players")
AllFun(Combat,"Auto Kill Players",nil,false,"Auto Kill Players")
AllFunSs(Combat,"Position Z [ Beside ]",nil,"Position Z [ Beside ]",25,10,60,0)
AllFunSs(Combat,"Height",nil,"Height",25,10,60,0)
AllFunSs(Combat,"Lowness",nil,"Lowness",25,10,60,0)
AllFun(Aimbot_Settings,"Enabled Aimbot",nil,false,"Enabled Aimbot")
AllFun(Other,"Boost",nil,false,"Boost")
AllFun(Other,"Enabled PvP",nil,false,"Enabled PvP")
AllFun(Other,"Auto Activate Ability",nil,false,"Auto Activate Ability")
AllFun(Other,"Safe Mode",nil,false,"Safe Mode")
